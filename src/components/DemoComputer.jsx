...
const DemoComputer = (props) => {
  ...
  const txt = useVideoTexture(props.texture ? props.texture : '/textures/project/project-1.mp4');

  useEffect(() => {
    if (txt) {
      // Disable vertical flip for video texture
      txt.flipY = false;

      // Access the video element and change playback rate
      if (txt.image) {
        txt.image.playbackRate = 2.0; // 2x speed, you can adjust this to any speed you want
      }
    }
  }, [txt]);
